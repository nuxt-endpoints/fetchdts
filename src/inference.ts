 ...
 *
 * This is the generic accessor for metadata added by a route compiler consumer. It returns
 * `Fallback` when the path does not resolve or the endpoint does not declare `Field`.
 */
