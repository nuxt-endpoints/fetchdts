...
// Usage: pnpm build && node scripts/generate-fixtures.mjs

import { writeFileSync } from 'node:fs'
import { fileURLToPath } from 'node:url'
// The source graph uses bundler-resolved extensionless imports, so plain Node cannot execute it.
// eslint-disable-next-line antfu/no-import-dist
import { compileRoutes } from '../dist/compiler.mjs'
// eslint-disable-next-line antfu/no-import-dist
import { DynamicParam, WildcardParam } from '../dist/index.mjs'
